...
3. Find `<?php comments_template() ?>` line from single.php OR loop-single.php and replace with `<?php if (function_exists('sc_comments_template')) { sc_comments_template(); } else { comments_template(); } ?>`
...
= I want a new feature for this plugin. How can I request it ? =

You can either go to the plugins page and leave a comment ( `http://wpideas.net/plugins/personal-plugins/sticky-comments/` ), or contact me here : `http://wpideas.net/contact/`
